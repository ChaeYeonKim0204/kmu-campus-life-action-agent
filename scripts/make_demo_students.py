...
# 기초교양 8학점(학과 시트: 글쓰기3·College EnglishⅠ·Ⅱ 택1 2·English Conversation 2·글로벌영어1)
# — EC는 별도 필수(2026-06-05 사용자 정정: 기초 필수 = 글쓰기/CE택1/EC 3종. 컴퓨팅적사고와
#   동일 2학점 교체라 총학점·영역 합계·데모 수치 전부 불변)
BASIC_ROWS = [("글쓰기", 3), ("College EnglishⅠ", 2), ("English Conversation", 2), ("글로벌영어", 1)]
