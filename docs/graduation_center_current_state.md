...
- **테스트**: **138 collected · 129 passed**(총평 17종 + 데모 학생 회귀 4종 포함)(+9 live-LLM opt-in skip) — 파이프라인·사정·해설 validator·상담 36종·API. (티어1 정리 전 전체 스위트는 236이었음 — 현행은 졸업센터 전용 수치.) 결정론 3회 해시 동일.
